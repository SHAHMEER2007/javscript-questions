...
// Q7: Odd numbers 1–15
let b = 1;
while (b <= 15) { if (b % 2 !== 0) console.log(b); b++; }
console.log("-----------");
...
// Q9: 20 to 10
let c = 20;
while (c >= 10) { console.log(c); c--; }
console.log("-----------");

// Q10: Print until sum > 30
let d = 1, total = 0;
while (total <= 30) {
  console.log(d);
  total += d;
...
// Q11: 1 to 5
let e = 1;
do { console.log(e); e++; } while (e <= 5);
console.log("-----------");

// Q12: Multiples of 3 up to 30
let f = 3;
do { console.log(f); f += 3; } while (f <= 30);
console.log("-----------");

// Q13: 15 down to 1
let g = 15;
do { console.log(g); g--; } while (g >= 1);
console.log("-----------");

// Q14: Numbers until product > 1000
let h = 1, product = 1;
do { console.log(h); product *= h; h++; } while (product <= 1000);
console.log("-----------");

// Q15: 1–10 but skip 5
let j = 1;
do { if (j !== 5) console.log(j); j++; } while (j <= 10);
console.log("============================\n");


// ================= CONDITIONAL STATEMENTS (Q16 – Q20) =================

// For input you can use prompt(), but here we use sample values

// Q16: Positive/Negative/Zero
let num = 0; // change value
